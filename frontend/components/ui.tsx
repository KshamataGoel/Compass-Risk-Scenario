...
export function Button({
  ...
  const styles =
    variant === "primary"
      ? "bg-accent text-ink font-semibold hover:bg-accent-dark shadow-sm"
  ...
  return (
    <button
      ...
      className={`ml-1 inline-flex h-4 w-4 items-center justify-center rounded-full border text-[10px] font-bold ${
        active ? "border-accent bg-accent text-ink" : "border-ink-muted/40 text-ink-muted hover:border-accent hover:text-accent"
      }`}
    >
      i
    </button>
